local c = require("custom.colors.customlight.palette")
...
theme.set_highlights = function()
	...
	hl(0, "CursorLine", { fg = "NONE", bg = c.bg_2 })
	hl(0, "CursorWord", { fg = "NONE", bg = c.info_yellow })
	hl(0, "CursorColumn", { fg = "NONE", bg = c.bg_2 })
	hl(0, "NormalFloat", { fg = "NONE", bg = c.bg_2 })
	hl(0, "Visual", { fg = "NONE", bg = c.visual_bg })
	hl(0, "VisualNOS", { fg = "NONE", bg = c.gray })
	hl(0, "WarningMsg", { fg = c.red, bg = c.bg })
	hl(0, "DiffAdd", { fg = c.bg_2, bg = c.sign_add })
	hl(0, "DiffChange", { fg = c.bg_2, bg = c.sign_change, underline = true })
	hl(0, "DiffDelete", { fg = c.bg_2, bg = c.sign_delete })
	hl(0, "QuickFixLine", { fg = "NONE", bg = c.ui2_blue })
	hl(0, "PmenuSbar", { fg = "NONE", bg = c.bg_2 })
	...
	hl(0, "IncSearch", { fg = c.bg_2, bg = c.search_orange })
	hl(0, "Substitute", { fg = c.search_orange, bg = c.bg_2 })
	...
	hl(0, "TabLine", { fg = c.gray, bg = c.border })
	hl(0, "TabLineSel", { fg = c.bg, bg = c.border })
	hl(0, "TabLineFill", { fg = c.border, bg = c.border })
	...
	hl(0, "TSText", { fg = c.fg_2, bg = "NONE" })
	hl(0, "TSOperator", { fg = c.fg_2, bg = "NONE" })
	hl(0, "TSPunctDelimiter", { fg = c.fg_2, bg = "NONE" })
	hl(0, "TSTagDelimiter", { fg = c.fg_2, bg = "NONE" })
	hl(0, "TSTagAttribute", { fg = c.orange, bg = "NONE" })
	hl(0, "TSPunctBracket", { fg = c.fg_2, bg = "NONE" })
	...
	hl(0, "TreesitterContext", { fg = "NONE", bg = c.bg_2 })
	...
	hl(0, "markdownIdDelimiter", { fg = c.fg_2, bg = "NONE" })
	hl(0, "markdownLinkDelimiter", { fg = c.fg_2, bg = "NONE" })
	...
	hl(0, "WhichKeyFloat", { fg = "NONE", bg = c.fg })
	...
	hl(0, "LspReferenceRead", { fg = "NONE", bg = c.info_yellow })
	hl(0, "LspReferenceText", { fg = "NONE", bg = c.info_yellow })
	hl(0, "LspReferenceWrite", { fg = "NONE", bg = c.hint_blue })
	...
	hl(0, "NvimTreeVertSplit", { fg = c.border, bg = c.border })
	...
	hl(0, "NvimTreeCursorLine", { fg = "NONE", bg = c.bg_2 })
	...
	hl(0, "BufferInactive", { fg = c.gray, bg = c.bg_2 })
	hl(0, "BufferInactiveIndex", { fg = c.gray, bg = c.bg_2 })
	hl(0, "BufferInactiveMod", { fg = c.info_yellow, bg = c.bg_2 })
	hl(0, "BufferInactiveSign", { fg = c.gray, bg = c.bg_2 })
	hl(0, "BufferInactiveTarget", { fg = c.red, bg = c.bg_2, bold = true })

	-- StatusLine
	hl(0, "StatusLine", { fg = c.border, bg = c.gray })
	hl(0, "StatusLineNC", { fg = c.border, bg = c.gray })
	hl(0, "StatusLineSeparator", { fg = c.border, bg = "NONE" })
	hl(0, "StatusLineTerm", { fg = c.border, bg = "NONE" })
	hl(0, "StatusLineTermNC", { fg = c.border, bg = "NONE" })

	-- IndentBlankline
	hl(0, "IndentBlanklineContextChar", { fg = c.context, bg = "NONE" })
	hl(0, "IndentBlanklineContextStart", { fg = "NONE", bg = "NONE", underline = true })
	hl(0, "IndentBlanklineChar", { fg = c.fg_2, bg = "NONE" })
