local c = require("custom.colors.customdark.palette")
...
theme.set_highlights = function()
	...
	hl(0, "Comment", { fg = c.bg_light, bg = "NONE", italic = true })
	hl(0, "Folded", { fg = c.gray, bg = c.bg })
	hl(0, "FoldColumn", { fg = c.gray, bg = c.bg })
	hl(0, "LineNr", { fg = c.gray_light, bg = "NONE" })
	hl(0, "FloatBorder", { fg = c.fg, bg = c.bg })
	hl(0, "Whitespace", { fg = c.bg, bg = "NONE" })
	hl(0, "VertSplit", { fg = c.fg, bg = c.bg })
	hl(0, "CursorLine", { fg = "NONE", bg = c.cursor_line_bg })
	hl(0, "CursorColumn", { fg = "NONE", bg = c.bg_light })
	hl(0, "NormalFloat", { fg = "NONE", bg = c.bg_light })
	hl(0, "Visual", { fg = "NONE", bg = c.visual_bg })
	hl(0, "VisualNOS", { fg = "NONE", bg = c.gray })
	...
	hl(0, "PmenuSbar", { fg = "NONE", bg = c.bg_light })
	...
	hl(0, "Search", { fg = c.fg, bg = c.search_orange })
	hl(0, "IncSearch", { fg = c.fg, bg = c.search_orange })
	hl(0, "Substitute", { fg = c.search_orange, bg = c.bg_light })
	...
	hl(0, "Keyword", { fg = c.dark_blue, bg = "NONE" })
	...
	hl(0, "Delimiter", { fg = c.fg_dark, bg = "NONE" })
	hl(0, "SpecialComment", { fg = c.fg_dark, bg = "NONE" })
	...
	hl(0, "TabLine", { fg = c.fg_dark, bg = c.fg })
	hl(0, "TabLineSel", { fg = c.bg, bg = c.fg })
	hl(0, "TabLineFill", { fg = c.fg, bg = c.fg })
	...
	hl(0, "TSText", { fg = c.fg_light, bg = "NONE" })
	hl(0, "TSOperator", { fg = c.fg_light, bg = "NONE" })
	hl(0, "TSPunctDelimiter", { fg = c.fg_light, bg = "NONE" })
	hl(0, "TSTagDelimiter", { fg = c.fg_light, bg = "NONE" })
	hl(0, "TSTagAttribute", { fg = c.orange, bg = "NONE" })
	hl(0, "TSPunctBracket", { fg = c.fg_light, bg = "NONE" })
	...
	hl(0, "TreesitterContext", { fg = "NONE", bg = c.bg_light })
	...
	hl(0, "markdownIdDelimiter", { fg = c.fg_light, bg = "NONE" })
	hl(0, "markdownLinkDelimiter", { fg = c.fg_light, bg = "NONE" })
	...
	hl(0, "markdownRule", { fg = c.bg, bg = "NONE" })
	...
	hl(0, "WhichKeyFloat", { fg = "NONE", bg = c.bg_light })
	...
	hl(0, "DiagnosticHint", { fg = c.bg_light, bg = "NONE" })
	...
	hl(0, "LspInlayHint", { fg = c.hint_blue, bg = "NONE" })
	...
	hl(0, "NvimTreeVertSplit", { fg = c.fg, bg = c.fg })
	...
	hl(0, "NvimTreeCursorLine", { fg = "NONE", bg = c.bg_light })
	...
	hl(0, "BufferInactive", { fg = c.gray, bg = c.bg_light })
	hl(0, "BufferInactiveIndex", { fg = c.gray, bg = c.bg_light })
	hl(0, "BufferInactiveMod", { fg = c.info_yellow, bg = c.bg_light })
	hl(0, "BufferInactiveSign", { fg = c.gray, bg = c.bg_light })
	hl(0, "BufferInactiveTarget", { fg = c.red, bg = c.bg_light, bold = true })

	-- StatusLine
	-- hl(0, "StatusLine", { fg = c.fg, bg = c.gray })
	-- hl(0, "StatusLineNC", { fg = c.fg, bg = c.gray })
	-- hl(0, "StatusLineSeparator", { fg = c.fg, bg = 'NONE' })
	-- hl(0, "StatusLineTerm", { fg = c.fg, bg = 'NONE' })
	-- hl(0, "StatusLineTermNC", { fg = c.fg, bg = 'NONE' })

	-- IndentBlankline
	hl(0, "IndentBlanklineContextChar", { fg = c.fg_dark, bg = "NONE" })
	hl(0, "IndentBlanklineContextStart", { fg = c.fg_dark, bg = "NONE", underline = true })
	hl(0, "IndentBlanklineChar", { fg = c.bg_light, bg = "NONE" })
	...
	hl(0, "@keyword.return.typescript", { fg = c.return_red })
	-- Svelte
	hl(0, "@tag.svelte", { fg = c.cyan })
